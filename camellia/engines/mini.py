...
class Engine:
    ...
    def Camellia_Ekeygen(self, rawKey):
        ...
        self.lib.camelliaKS(len(rawKey)*8, rawKey, keytable)
    ...
    def Camellia_Encrypt(self, keyLength, keytable, plainText):
        ...
        self.lib.camellia(0, keyLength, plainText, keytable, cipher)
    ...
    def Camellia_Decrypt(self, keyLength, keytable, cipherText):
        ...
        self.lib.camellia(1, keyLength, cipherText, keytable, clear)
